...
class MainApplication(QMainWindow):
    ...
    def quit_application(self):
        ...
        QTimer.singleShot(0, self.perform_shutdown)

    def perform_shutdown(self):
        future = asyncio.run_coroutine_threadsafe(self.task_manager.shutdown(), self.loop)
        future.add_done_callback(self.final_cleanup)

    def final_cleanup(self, future):
        try:
            future.result()  # This will raise any exception that occurred during shutdown
