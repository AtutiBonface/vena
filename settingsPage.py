...
class SettingsWindow(QFrame):
    def __init__(self):
        ...
        self.general_settings = General()
        self.management_settings = DownloadManagement()
        self.browser_settings = BrowserInteraction()
        self.user_prefferences = UserPreferences()
...
class General(QFrame):
    def __init__(self, ):
       ...
       # General Settings Tab
        ...
        auto_start = QCheckBox("Auto-Start VenaApp with system")
        general_layout.addWidget(auto_start)
        browser_combo = QComboBox()
        browser_combo.addItems(["Chrome", "Firefox", "Edge", "Safari"])
...
class DownloadManagement(QFrame):
    def __init__(self):
        ...
        simultaneous_spin = QSpinBox()
        simultaneous_spin.setRange(1, 10)
        simultaneous_downloads.addWidget(simultaneous_spin)
        ...
        resume_pause = QCheckBox("Auto-resume paused or interrupted downloads")
        resume_pause.setStyleSheet("margin-left: 1px; padding-left: 10px;")
        download_layout.addWidget(resume_pause)
...
class BrowserInteraction(QFrame):
    def __init__(self):
        ...
        extension_toggle = QCheckBox("Enable Browser Extension")
        extension_toggle.setStyleSheet("padding: 10px;")
        browser_layout.addWidget(extension_toggle)
        ...
        download_confirm = QCheckBox("Enable download confirmation pop-ups")
        download_confirm.setStyleSheet("padding: 10px;")
        browser_layout.addWidget(download_confirm)
        context_menu = QCheckBox("Enable context menu options in browser")
        context_menu.setStyleSheet("padding: 10px;")
        browser_layout.addWidget(context_menu)
